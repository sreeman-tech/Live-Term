...
- [personal website](https://sreemantech.vercel.app/)
- [liveterm startpage](https://livetermstart.vercel.app/)
- [project page](https://github.com/sreeman-tech/Live-Term)
...
<p align="center">
<img src="./demo/demo.gif" width="600"><br>
<strong><a href="https://sreemantech.vercel.app/" target=_blank>my personal website</a></strong>
</p>
...
```bash
sh -c "$(curl -fsSL https://raw.github.com/sreeman-tech/LiveTerm/main/install/install.sh)"
```
...
```bash
git clone https://github.com/sreeman-tech/Live-Term.git && cd LiveTerm
```
...
Based on M4TT72's awesome [Terminal](https://github.com/ICD-ATOMS/).
